...
namespace Valve.VR.InteractionSystem
{
    ...
    public class Interactable : MonoBehaviour
    {
        ...
        protected virtual void OnHandHoverBegin(Hand hand)
        {
            ...
            hoveringHand = hand;
            player.GetComponent<PickupWeapon>().gunInCar = gameObject;
            player.GetComponent<PickupWeapon>().gunInHand = gunModel;
        ...
        public void endHover()
        {
            wasHovering = isHovering;
            isHovering = false;
            if (player.GetComponent<PickupWeapon>().gunInCar == gameObject) player.GetComponent<PickupWeapon>().gunInCar = null;
            if (player.GetComponent<PickupWeapon>().gunInHand == gunModel) player.GetComponent<PickupWeapon>().gunInHand = null;
